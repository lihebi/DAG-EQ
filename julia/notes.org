...
Now I fixed the equivariant model problems:
1. running time
2. convergence: w2=w3 problem

I need to start to run different settings, collect data, and compare with other
methods.
...
** China
*** TODO Look for other potential bugs in equivariant model
